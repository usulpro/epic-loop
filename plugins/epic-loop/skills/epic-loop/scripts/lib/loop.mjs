...
const MANAGER_PROMPT_TEMPLATE_PATH = path.join(SKILL_DIR, "assets", "templates", "implementation-manager-prompt.md");
...
function buildManagerPrompt(slug, iteration, housekeepingReason) {
