  ...
  return (
    ...
    >
      <div className="flex w-full flex-row-reverse items-center justify-end gap-x-2 gap-y-4 md:w-40 md:shrink-0 md:flex-col md:items-start md:justify-start md:pt-2 lg:w-56">
        ...
        <div
          className="size-1 shrink-0 rounded-full bg-muted-foreground/40 md:hidden"
          aria-hidden
        />
        <Category isFeatured={isFeatured} category={category} />
      </div>
      <div className="flex grow flex-col">
        ...
        <Authors className="mt-3 shrink-0 lg:mt-4" authors={authors} size="xs" />
      </div>
    </article>
  );
}
