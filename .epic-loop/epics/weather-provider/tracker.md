...
- [x] Kind: documentation-only | Status: done | Capture the weather integration problem framing.
...
- [x] Kind: documentation-only | Status: done | Select the initial weather provider and record tradeoffs.
...
- [x] Kind: documentation-only | Status: done | Split the epic into technical implementation phases and keep the roadmap current as scope changes.
...
- [ ] Kind: implementation | Status: todo | Define the weather domain contract and provider boundary.
...
- [ ] Kind: implementation | Status: todo | Add an Open-Meteo geocoding adapter.
...
- [ ] Kind: implementation | Status: todo | Add a local geocoding API route.
...
- [ ] Kind: implementation | Status: todo | Add an Open-Meteo current-weather adapter.
...
- [ ] Kind: implementation | Status: todo | Add a local current-weather API route.
...
- [ ] Kind: implementation | Status: todo | Map weather codes to display conditions, icons, and palettes.
...
- [ ] Kind: verification | Status: todo | Verify weather data contracts.
...
- [ ] Kind: implementation | Status: todo | Add the dedicated `/weather` page and route metadata.
...
- [ ] Kind: implementation | Status: todo | Build the location search input with debounced lookup.
...
- [ ] Kind: implementation | Status: todo | Render selectable location suggestions.
...
- [ ] Kind: implementation | Status: todo | Build the selected weather panel.
...
- [ ] Kind: implementation | Status: todo | Add user-facing error and retry states.
...
- [ ] Kind: implementation | Status: todo | Persist the selected location and weather snapshot.
...
- [ ] Kind: verification | Status: todo | Verify the weather page experience.
...
- [ ] Kind: implementation | Status: todo | Add a global weather client provider.
...
- [ ] Kind: implementation | Status: todo | Build the large hero weather artwork component.
...
- [ ] Kind: implementation | Status: todo | Define scoped hero weather palettes and layout tokens.
...
- [ ] Kind: implementation | Status: todo | Integrate weather visuals into primary page heroes.
...
- [ ] Kind: implementation | Status: todo | Refresh weather state across pages for hero usage.
...
- [ ] Kind: implementation | Status: todo | Add navigation to the weather page.
...
- [ ] Kind: verification | Status: todo | Verify cross-page hero behavior.
...
- [ ] Kind: implementation | Status: todo | Add a permission-aware browser geolocation helper.
...
- [ ] Kind: implementation | Status: todo | Add a gentle geolocation suggestion to the weather page.
...
- [ ] Kind: implementation | Status: todo | Preview current-location weather before applying it.
...
- [ ] Kind: implementation | Status: todo | Require explicit confirmation before selecting geolocation.
...
- [ ] Kind: implementation | Status: todo | Handle denied and unavailable geolocation states gently.
...
- [ ] Kind: implementation | Status: todo | Preserve privacy-sensitive geolocation behavior.
...
- [ ] Kind: verification | Status: todo | Verify geolocation helper behavior.
