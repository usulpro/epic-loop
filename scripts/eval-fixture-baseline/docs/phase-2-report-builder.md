...
Fixture task-owned commits must continue to be made inside `temp/eval-fixture-project` or through `git -C temp/eval-fixture-project ...`. Do not stage or commit fixture output from the root repository.

## Implementation Surface

- `temp/eval-fixture-project/src/report-builder.mjs`
- `temp/eval-fixture-project/test/report-builder.test.mjs`
- `temp/eval-fixture-project/verification/phase-2.md`
...
- `temp/eval-fixture-project/verification/phase-2.md` records the command and result
